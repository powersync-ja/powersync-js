import { BaseTable, Column, ColumnsType, Schema, Table } from '@powersync/web';
...
export class JsSchemaGenerator {
  ...
  private generateTables(tables: BaseTable[]): string {
  ...
  private generateAppSchema(tables: BaseTable[]): string {
