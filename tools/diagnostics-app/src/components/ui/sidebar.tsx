    ...
    <div
      ...
      <div
        ...
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm overscroll-contain">
          {children}
        </div>
      </div>
    </div>
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<'li'>) {
  return (
    <li
      ...
      className={cn('group/menu-item relative group-data-[collapsible=icon]:w-fit', className)}
      {...props}
    />
  );
}
