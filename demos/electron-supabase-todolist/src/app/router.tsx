...
import RegisterPage from './auth/register/page.jsx';
import EntryPage from './page.jsx';
import TodoEditPage from './views/todo-lists/edit/page.jsx';
import TodoListsPage from './views/todo-lists/page.jsx';
import ViewsLayout from './views/layout.jsx';
import SQLConsolePage from './views/sql-console/page.jsx';
