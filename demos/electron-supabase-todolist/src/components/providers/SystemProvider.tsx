import { NavigationPanelContextProvider } from '../navigation/NavigationPanelContext.jsx';
import { AppSchema } from '../../library/powersync/AppSchema.js';
import { SupabaseConnector } from '../../library/powersync/SupabaseConnector.js';
...
import { configureFts } from '../../app/utils/fts_setup.js';
