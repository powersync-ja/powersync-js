import { SearchResult, searchTable } from '../../app/utils/fts_helpers.js';
import { Autocomplete, Box, Card, CardContent, FormControl, TextField, Typography } from '@mui/material';
import React from 'react';
import { useNavigate } from 'react-router-dom';
import { TODO_LISTS_ROUTE } from '../../app/router.jsx';
import { usePowerSync } from '@powersync/react';
import { LISTS_TABLE, ListRecord } from '../../library/powersync/AppSchema.js';
