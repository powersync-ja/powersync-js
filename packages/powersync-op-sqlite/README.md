...
This package (`packages/powersync-op-sqlite`) enables using OP-SQLite with PowerSync. It is an extension of `packages/common` and it is used with `@powersync/react-native` ([Usage](#usage)).
